...
var ModalDialog = (function (_React$Component) {
  ...
  function ModalDialog() {
    ...
    this.componentWillMount = function () {
       ...
       */
      _this.eventToken = _activeEventStack2['default'].addListenable([['keydown', _this.handleGlobalKeydown]]);
    };
    ...
    this.render = function () {
      ...
      var closeBackgroundFill = _props.closeBackgroundFill;
      var closeXFill = _props.closeXFill;

      var rest = _objectWithoutProperties(_props, ['topOffset', 'leftOffset', 'width', 'className', 'children', 'onClose', 'margin', 'style', 'sheet', 'closeBackgroundFill', 'closeXFill']);
      ...
      return _react2['default'].createElement(
        ...
        onClose ? _react2['default'].createElement(
          ...
          _react2['default'].createElement(_CloseCircle2['default'], { backgroundFill: closeBackgroundFill, diameter: 40, xFill: closeXFill })
        ) : null,
        children
      );
    };
  ...
  _createClass(ModalDialog, null, [{
    ...
    value: {
      ...
      closeBackgroundFill: _react.PropTypes.string,
      closeXFill: _react.PropTypes.string
    },
    enumerable: true
  }, {
    key: 'defaultProps',
